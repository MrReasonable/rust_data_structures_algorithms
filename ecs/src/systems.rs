use termion::{color, cursor, raw::RawTerminal, terminal_size};
...
pub fn move_sys<D, P>(dd: &D, pp: &mut P)
where
    D: EcsStoreIter<Dir>,
    P: EcsStoreIter<Pos>,
{
    pp.for_each_mut(move |g, p| {
...
pub fn dir_sys<D, P>(dd: &mut D, pp: &P)
where
    D: EcsStoreIter<Dir>,
    P: EcsStoreIter<Pos>,
{
...
pub fn collision_sys<P, S>(pp: &P, ss: &mut S)
where
    P: EcsStoreIter<Pos>,
    S: EcsStoreIter<Strength>,
{
...
pub fn render_sys<T, P, S>(t: &mut RawTerminal<T>, pp: &P, ss: &S)
where
    T: std::io::Write,
    P: EcsStoreIter<Pos>,
    S: EcsStoreIter<Strength>,
...
pub fn death_sys<S, P, D>(g: &mut GenManager, ss: &mut S, pp: &mut P, dd: &mut D)
where
    S: EcsStoreIter<Strength>,
    P: EcsStoreIter<Pos>,
    D: EcsStoreIter<Dir>,
